...
beautiful.wibar_bg = "#250e16"
beautiful.fg_normal = "#888A85"
beautiful.fg_focus = "#E9DEFA"
beautiful.bg_minimize = "#2E3440"
...
-- APPS
    ...
    awful.util.spawn("brave") end, 
              {description = "Open Brave Browser", group = "app"}),
    awful.key({ modkey            }, ".",      function()
    awful.util.spawn("amberol") end, 
              {description = "Open Amberol Music", group = "app"}),
